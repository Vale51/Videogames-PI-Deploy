import { ADD_GAME, ORDER_NAME, REMOVE_GAME, GET_GAMES, SEARCH_GAME, SEARCH_GAME_ERROR, GET_DETAIL, GET_GENRES, FILTER_GENRE, FILTER_ORIGIN, ORDER_RATING, CHANGE_PAGE } from "./action-types"
