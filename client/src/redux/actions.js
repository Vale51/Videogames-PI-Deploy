import { ADD_GAME, ORDER_NAME, REMOVE_GAME, GET_GAMES, SEARCH_GAME, GET_DETAIL, GET_GENRES, SEARCH_GAME_ERROR, FILTER_GENRE, FILTER_ORIGIN, ORDER_RATING, CHANGE_PAGE } from "./action-types"
